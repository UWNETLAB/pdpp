...
# from pdpp.pdpp_class import step_class, export_class, project_class
...
#     riggable_classes = get_pdpp_tasks() 
...
#         else:
#             new_step_metadata = project_class(
#                 target_dir=str(target_dir), 
#                 dep_files=dep_files_dict,
#                 import_files=import_list,
#                 enabled=step_metadata.enabled
